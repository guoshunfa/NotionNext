...
module.exports = {
  // 谷歌广告
  // ADSENSE_GOOGLE_ID: process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_ID || 'pub-3014306888926655', // 谷歌广告ID e.g ca-pub-xxxxxxxxxxxxxxxx
  ...
  //   process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_SLOT_FLOW || '3686139735', // Google AdScene>广告>按单元广告>新建信息流广告
  ...
  //   process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_SLOT_AUTO || '2983400330', // Google AdScene>广告>按单元广告>新建展示广告 （自动广告）
